...
class BaseMQTTClientWrapperCanConnectTest {
    ...
    @Test
    void testCanCollecting_shouldReturnTrue() {
        // Given
        taskStage.set(TaskStage.COLLECTING);

        // When
        boolean result = testWrapper.canConnect(TaskStage.COLLECTING);
    ...
    @Test
    void testCanConnect_INIT_PUB_CLIENTED_shouldReturnTrue() {
        // Given
        taskStage.set(TaskStage.INIT_PUB_CLIENTED);

        // When
        boolean result = testWrapper.canConnect(TaskStage.INIT_PUB_CLIENTED);
    ...
    @Test
    void testCanConnect_INIT_SUB_CLIENTED_shouldReturnTrue() {
        // Given
        taskStage.set(TaskStage.INIT_SUB_CLIENTED);

        // When
        boolean result = testWrapper.canConnect(TaskStage.INIT_SUB_CLIENTED);
    ...
    @Test
    void testCanConnect_ASSIGNED_shouldReturnTrue() {
        // Given
        taskStage.set(TaskStage.ASSIGNED);

        // When
        boolean result = testWrapper.canConnect(TaskStage.ASSIGNED);
    ...
    @Test
    void testCanConnect_SHUTDOWN_ING_shouldReturnFalse() {
        // Given
        taskStage.set(TaskStage.SHUTDOWN_ING);

        // When
        boolean result = testWrapper.canConnect(TaskStage.SHUTDOWN_ING);
    ...
    @Test
    void testCanConnect_BREAKING_shouldReturnFalse() {
        // Given
        taskStage.set(TaskStage.BREAKING);

        // When
        boolean result = testWrapper.canConnect(TaskStage.BREAKING);
    ...
    private static class TestWrapper extends BaseMQTTClientWrapper {
        ...
        @Override
        public void connect(Consumer<ConnectionStatus> connectCallback,
                          com.baidu.iot.test.suite.IPubMsgListener pubMsgListener) {
            // Not needed for this test
        }
