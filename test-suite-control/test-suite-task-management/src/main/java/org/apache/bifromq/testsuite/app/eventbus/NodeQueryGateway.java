...
public interface NodeQueryGateway {
    ...
    CompletableFuture<NodeMetricsResponse> queryMetrics(NodeMetricsRequest request);

    CompletableFuture<ClientQueryResponse> queryClients(String nodeId, ClientQueryRequest request);
