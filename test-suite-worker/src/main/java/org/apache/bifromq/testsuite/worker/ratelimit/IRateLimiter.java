...
public interface IRateLimiter {
    static IRateLimiter create(Type type, int permitsPerSecond) {
        return create(type, (double) permitsPerSecond);
    }

    static IRateLimiter create(Type type, double permitsPerSecond) {
    ...
    double getPermitsPerSecondValue();
    ...
    CompletableFuture<Void> executeContinuously(Function<Long, CompletableFuture<Void>> action);
